...
class TestInheritance(LsTestCase):
    ...
    def test_wrong_parent_name(self):
        ...
        xscale: all  # Just to finish the parsing of bar
        '''
        msg = "Error on line 8: Invalid phase label 'foofel'."
    ...
    def test_wrong_child_name(self):
        ...
        xscale: all  # Just to finish the parsing of bar
        '''
        msg = "Error on line 8: Redefinition of phase 'foo'."
        with self.assertRaisesMsg(msg):
            parse(text, 'bar')
    ...
    def test_wrong_syntax(self):
        ...
        xscale: all  # Just to finish the parsing of bar
        '''
        msg = "Error on line 8: Phase stop condition must have the form 'stop:condition'."
        with self.assertRaisesMsg(msg):
            parse(text, 'bar')
    ...
    def test_wrong_parentheses1(self):
        ...
        xscale: all  # Just to finish the parsing of bar
        '''
        msg = "Error on line 8: Invalid phase label '(foo)'."
        with self.assertRaisesMsg(msg):
            parse(text, 'bar')
    ...
    def test_wrong_parentheses2(self):
        ...
        xscale: all  # Just to finish the parsing of bar
        '''
        msg = "Error on line 8: Phase label 'bar(foo)baz' is not a valid identifier."
        with self.assertRaisesMsg(msg):
            parse(text, 'bar')
    ...
    def test_wrong_parentheses3(self):
        ...
        xscale: all  # Just to finish the parsing of bar
        '''
        msg = "Error on line 8: Phase label 'barbazfoo)' is not a valid identifier."
        with self.assertRaisesMsg(msg):
            parse(text, 'bar')
    ...
    def test_reference_to_undefined_local_variable(self):
        ...
        msg = "Error on line 12: Unknown variable 'local_var'."
        with self.assertRaisesMsg(msg):
            stimulus = phase.next_stimulus('b2')[0]
...
class TestMultipleActions(LsTestCase):
    ...
    def test_conditional_and_unconditional_actions_exceptions(self):
        ...
        E3 e3      | E0
        '''
        msg = "Error on line 9: Invalid condition 'E1,E2,E3'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
    ...
    def test_exceptions(self):
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Invalid condition 'B,A(1.1)'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Invalid condition 'B(1.1),A(1.1)'. Expected a probability, got '1.1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        @run phase_label
        '''
        msg = "Error on line 9: No condition in 'b1: x1:1, x2:2, B' was met for response 'b2'."
        with self.assertRaisesMsg(msg):
            run(text)
        ...
        @run phase_label
        '''
        msg = "Error on line 9: Error in expression 'b1 b2 == x3 x4': invalid syntax."
        with self.assertRaisesMsg(msg):
            run(text)
        ...
        C e1       | A
        '''
        msg = "Error on line 9: The unconditional goto row label 'B' cannot be continued."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        @run phase_label
        '''
        msg = "Error on line 9: Condition 'b1&5' is not a boolean expression."
        with self.assertRaisesMsg(msg):
            run(text)
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Invalid statement 'x1::1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Invalid statement 'foo:bar:1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Invalid statement 'foo:bar:baz:1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Condition on help line cannot depend on response."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Row label(s) must be the last action(s). Found 'x3:3' after row-label."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Last action must be a row label, found 'x3:3'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Variable name '1x' is not a valid identifier."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Unknown action '1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 9: Variable name 'e2' equals a stimulus element name."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Cannot modify global variable inside a phase."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Unknown event 'foo' in count_reset."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Unknown action 'blaps'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Unknown action 'x2'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Unknown action 'e2'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
        ...
        B e2       | A
        '''
        msg = "Error on line 10: Unknown action 'b2'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
...
class TestExceptions(LsTestCase):
    ...
    def test_no_label(self):
        ...
        @PHASE
        '''
        msg = "Error on line 2: @PHASE line must have the form '@PHASE label stop:condition'."
        with self.assertRaisesMsg(msg):
            parse(text, '_')
    ...
    def test_wrong_stopcond(self):
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 4: Unknown variable 'e11'."
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 4: Condition 'e1' is not a boolean expression."
        phase.next_stimulus(None)
        with self.assertRaisesMsg(msg):
            phase.next_stimulus('b1')
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 4: Unknown variable 'count'."
        phase.next_stimulus(None)
        with self.assertRaisesMsg(msg):
            phase.next_stimulus('b1')
    ...
    def test_empty_stopcond(self):
        ...
        L2 e2 | L1
        '''
        msg = "Error on line 4: Phase stop condition must have the form 'stop:condition'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
    ...
    def test_help_line_with_response(self):
        ...
        H     | b1:L1 | L1
        '''
        msg = "Error on line 6: Condition on help line cannot depend on response."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
    ...
    def test_modify_global_variable(self):
        ...
        L2 e2          | L1
        '''
        msg = "Error on line 7: Cannot modify global variable inside a phase."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
    ...
    def test_unknown_local_variable(self):
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 5: Unknown variable 'y'."
        with self.assertRaisesMsg(msg):
            phase.next_stimulus(None)
    ...
    def test_syntax_error_in_expression(self):
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 5: Error in expression '1+/1': invalid syntax."
        with self.assertRaisesMsg(msg):
            phase.next_stimulus(None)
    ...
    def test_cannot_evaluate_expression(self):
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 5: Cannot evaluate expression 'rand(1,)': rand() missing 1 required positional argument: 'stop'."
        with self.assertRaisesMsg(msg):
            phase.next_stimulus(None)
    ...
    def test_eval_output_not_number(self):
        ...
        '''
        phase = parse(text, 'phase_label')
        msg = "Error on line 5: Error in expression ''foo''."
        with self.assertRaisesMsg(msg):
            phase.next_stimulus(None)
    ...
    def test_invalid_count_reset(self):
        ...
        L3 e2               | L1
        '''
        msg = "Error on line 7: Unknown event 'e1X' in count_reset."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
    ...
    def test_invalid_line_label_in_logic(self):
        ...
        XL3 e2              | L1
        '''
        msg = "Error on line 5: Unknown action 'H'."
        with self.assertRaisesMsg(msg):
            parse(text, 'phase_label')
    ...
    def test_phase_line_contains_only_label(self):
        ...
        XL3 e2              | L1
        '''
        msg = "Error on line 6: Phase line contains only label."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_phase_line_label_is_stimulus(self):
        ...
        L3 e2              | L1
        '''
        msg = "Error on line 5: The phase line label 'FOO' coincides with the name of a stimulus element."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_phase_line_label_is_behavior(self):
        ...
        L3  e2              | L1
        '''
        msg = "Error on line 6: The phase line label 'b1' coincides with the name of a behavior."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_duplicate_phase_line_label(self):
        ...
        L1  e2              | L1
        '''
        msg = "Error on line 8: Duplicate of phase line label 'L1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_missing_separator(self):
        ...
        L2  e2
        '''
        msg = "Error on line 6: Missing separator '|' on phase line."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_unknown_stimulus_element_or_action(self):
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 5: Unknown action 'e11'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        L2  e2             | L1
        '''
        msg = "Error on line 5: Unknown action 'coun_reset(e1)'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_invalid_stimulus_element(self):
        ...
        L2  e2     | L1
        '''
        msg = "Error on line 5: Expected a stimulus element, got 'e11'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_no_conditions(self):
        ...
        L2  e2   |
        '''
        msg = "Error on line 6: Line with label 'L2' has no conditions."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_unknown_event_in_count_reset(self):
        ...
        L2  count_reset(foo)   |
        '''
        msg = "Error on line 6: Unknown event 'foo' in count_reset."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
    ...
    def test_no_condition_met(self):
        ...
        stimulus = phase.next_stimulus(None)[0]
        self.assertEqual(stimulus, {'e1': 1})
        msg = "Error on line 5: No condition in 'b3=7:L2 | b2=42:L2' was met for response 'b1'."
        with self.assertRaisesMsg(msg):
            phase.next_stimulus('b1')
        ...
        phase = parse(text, 'vi')
        stimulus = phase.next_stimulus(None)[0]
        msg = "Error on line 12: No condition in 'ON(1/6),FI2(1/6),FI3(1/6)' was met for response 'R'."
        with self.assertRaisesMsg(msg):
            for _ in range(100):
    ...
    def test_prob_greater_than_1(self):
        ...
        @run vi
        """
        msg = "Error on line 12: Sum of probabilities is 1.5>1."
        with self.assertRaisesMsg(msg):
            run(text)
    ...
    def test_condition_not_boolean(self):
        ...
        @run thelabel
        '''
        msg = "Error on line 8: Condition '42' is not a boolean expression."
        with self.assertRaisesMsg(msg):
            run(text)
            # phase = parse(text, 'thelabel')
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 5: Variable name 'e1' equals a stimulus element name."
        with self.assertRaisesMsg(msg):
            phase = parse(text, 'thelabel')
    ...
    def test_invalid_condition(self):
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 5: Invalid condition 'L2(0.5),L1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        msg = "Error on line 5: Unknown action 'L2((0.5))'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 5: Unknown action 'LL1(0.1)'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 5: Invalid condition 'L2(0.5),L1(1.1)'. Expected a probability, got '1.1'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 5: Invalid condition 'L2(0.2),L1(-0.9)'. Expected a probability, got '-0.9'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        L3  e1  | L2
        '''
        msg = "Error on line 5: Invalid condition 'L2(0.5),L1(0.2),L2(0.01)'. Label 'L2' duplicated."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        L2  e2  | L1
        '''
        msg = "Error on line 8: Unknown action 'L22'."
        with self.assertRaisesMsg(msg):
            parse(text, 'thelabel')
        ...
        @run thelabel
        '''
        msg = "Error on line 9: Sum of probabilities is 1.1>1."
        with self.assertRaisesMsg(msg):
            run(text)
    ...
    def test_invalid_options_to_choice(self):
        ...
        @run lbl
        '''
        msg = "Error on line 8: Cannot evaluate expression 'choice(1,2,[32,23,43])': The number of weights does not match the population."
        with self.assertRaisesMsg(msg):
            run(text)
