...
class TestExceptions(LsTestCase):
    ...
    def test_duplicate(self):
        ...
        '''.format(name)
        msg = "Error on line 3: Error in parameter '{}': 'foo' is an invalid behavior name.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
    ...
    def test_behavior_not_defined(self):
        ...
        {}: foo
        '''.format(name)
        msg = "Error on line 2: The parameter 'behaviors' must be assigned before the parameter '{}'.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
    ...
    def test_invalid_value(self):
        ...
        text = '''behaviors: b1, b2
                  {}: default::111
               '''.format(name)
        msg = "Error on line 2: Expected 'element:value' or 'default:value' in '{}', got 'default::111'.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
        ...
        text = '''behaviors: b1, b2
                  {}: b1->b1:1, blabla
               '''.format(name)
        msg = "Error on line 2: Error in parameter '{}': 'b1->b1' is an invalid behavior name.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
    ...
    def test_multiple_single_values(self):
        ...
        {}: 1, 2
        '''.format(name)
        msg = "Error on line 3: Expected 'element:value' or 'default:value' in '{}', got '1'.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
        ...
        {}: b1:3.22, 42
        '''.format(name)
        msg = "Error on line 3: Expected 'element:value' or 'default:value' in '{}', got '42'.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
    ...
    def test_invalid_behavior_name(self):
        ...
        '''.format(name)
        msg = "Error on line 3: Error in parameter '{}': 'b2->b2' is an invalid behavior name.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
        ...
        {}: B1:3.22, default:12
        '''.format(name)
        msg = "Error on line 3: Error in parameter '{}': 'B1' is an invalid behavior name.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
    ...
    def test_invalid_eb(self):
        ...
        '''.format(name)
        msg = "Error on line 3: Error in parameter '{}': 'kajsa' is an invalid behavior name.".format(name)
        with self.assertRaisesMsg(msg):
            parse(text)
